/**
 * Create three different users in the Firebase Authentication console
 * These users will later have roles assigned using custom claims.
 * 
 * admin@test.com test123!
 * manager@test.com manage123!
